...
File file = new File("src//main//resources//static//imgs//projetos");
		...
		ModelAndView modelAndView = new ModelAndView("adminProjetos").addObject("projeto", new Projetos()).addObject("listImagens", imagensCursos);
		return modelAndView;
	...
	public ModelAndView add(
			@ModelAttribute(value = "projeto") 
			@Valid Projetos projetos, 
		...
		return new ModelAndView("redirect:/adminProjetos");
